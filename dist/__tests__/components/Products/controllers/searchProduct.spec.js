...
describe("Search a product", () => {
    ...
    describe("Should find a product By Id", () => {
        ...
        it("Should find a product By Id and throw error that product does not exist", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("Should find a product By Id and returns it", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("Should search for products that match some texts", () => __awaiter(void 0, void 0, void 0, function* () {
        const responseHandlerSpy = jest.spyOn(response, "responseHandler");
        const { body, status } = yield (0, supertest_1.default)(app_1.default)
    ...
    it("Should find all the products in the database and retrieve them", () => __awaiter(void 0, void 0, void 0, function* () {
        const responseHandlerSpy = jest.spyOn(response, "responseHandler");
        const { body, status } = yield (0, supertest_1.default)(app_1.default)
            .get(`/v1/product`)
            .set("Authorization", `Bearer ${token}`);
...
//# sourceMappingURL=searchProduct.spec.js.map