...
describe("Create a product", () => {
    ...
    it("Should throw error that product already exist", () => __awaiter(void 0, void 0, void 0, function* () {
        const responseHandlerSpy = jest.spyOn(response, "responseHandler");
        const { body, status } = yield (0, supertest_1.default)(app_1.default)
            .post("/v1/product")
            .send(productTestData_1.productTestData)
    ...
    it("Should create a new product and save to the database", () => __awaiter(void 0, void 0, void 0, function* () {
...
//# sourceMappingURL=createProduct.spec.js.map