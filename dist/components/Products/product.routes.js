...
router.delete("/", (0, inputValidator_1.default)(product_validators_1.deleteProductSchema), tokenValidator_1.default, requireAuth_1.default, deleteProduct_1.default);
router.patch("/", (0, inputValidator_1.default)(product_validators_1.editProductSchema), tokenValidator_1.default, requireAuth_1.default, editProduct_1.default);
router.get("/", (0, inputValidator_1.default)(product_validators_1.editProductSchema), tokenValidator_1.default, requireAuth_1.default, editProduct_1.default);
